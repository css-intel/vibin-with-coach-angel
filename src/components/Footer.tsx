          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-sage-800 flex items-center justify-center hover:bg-lavender-600 transition-colors" aria-label="Instagram">
                ...
                <a href="#" className="w-10 h-10 rounded-full bg-sage-800 flex items-center justify-center hover:bg-lavender-600 transition-colors" aria-label="YouTube">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
